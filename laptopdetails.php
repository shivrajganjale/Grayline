...
body{
    background: url("images/IMG-640077e3b4fff4.46410940.jpg");
...
<?php 
  ...
  <div class="cd">
    <div class="main">
      ...
      <div><h1 class="overview">OUR Laptop OVERVIEW</h1>
    ...
    <div class="box">
       <div class="imgBx">
        ...
        <div class="content">
            ...
            <h2>Laptop Model : <a><?php echo $result['FUEL_TYPE']?></a> </h2>
            <h2>Quantity : <a><?php echo $result['CAPACITY']?></a> </h2>
