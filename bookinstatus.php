...
<?php
    ...
    if($rows==null){
        ...
        echo '<script> window.location.href = "laptopdetails.php";</script>';
    }
    else{
...
?>
   <ul><li> <button  class="utton"><a href="laptopdetails.php">Go to Home</a></button></li><li class="name">HELLO! <?php echo $rows2['FNAME']." ".$rows2['LNAME']?></li>
    ...
    <div class="box">
         <div class="content">
             <h1>LAPTOP NAME : <?php echo $rows3['CAR_NAME']?></h1><br>
