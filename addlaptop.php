...
<button id="back"><a href="adminlaptop.php">HOME</a></button> 
 ...
 <div class="main">
        ...
        <form id="register"  action="upload.php" method="POST" enctype="multipart/form-data">    
            ...
            <label>Laptop Specification : </label>
            <br>
            <input type ="text" name="ftype"
            id="name" placeholder="Enter Processor Type" required>
            <br><br>

            <label>Quantity : </label>
            <br>
            <input type="number" name="capacity" min="1"
            id="name" placeholder="Enter Quantity" required>
            <br><br>
           ...
           <br><br>
            ...
            <input type="submit" class="btnn"  value="Add Laptop" name="addcar">
