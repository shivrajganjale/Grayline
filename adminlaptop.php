...
<div class="hai">
        ...
        <div>
            <h1 class="header"></h1>
            <button class="add"><a href="addlaptop.php">+ ADD Laptop</a></button>
            <div>
                <div>
                ...
                <tr  class="active-row">
                    ...
                    ?></php></td>
                    <td><button type="submit" class="but" name="approve"><a href="deletelaptop.php?id=<?php echo $res['CAR_ID']?>">DELETE LAPTOP</a></button></td>
